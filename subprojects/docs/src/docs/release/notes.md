...
Building on top of the new optional dependencies support, Gradle now supports the import of BOMs by declaring them as dependencies.
This allows declaring dependencies without versions and using a BOM to derive a set of compatible versions. 
